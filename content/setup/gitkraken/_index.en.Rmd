...
<!-- IMPORTANT  - If you modify this file it will _not_ get deployed automatically you must render -->
<!--              it to html locally and include the .html in your commit for it to be deplyed     -->
<!--                                                                                               -->
<!--              Rscript -e "rmarkdown::render('_index.en.Rmd', output_format='html_document')"   -->
<!--              git add _index.en.{Rmd,html}                                                     -->
...
Then follow the [installation instructions](https://help.gitkraken.com/gitkraken-desktop/how-to-install/) provided on their website.
...
```{r, echo=FALSE}
knitr::include_url("https://help.gitkraken.com/gitkraken-desktop/github-gitkraken-desktop/")
```
