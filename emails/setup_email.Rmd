...
We’ll **kick off at `r params$event_start_time` on `r format(strptime(params$event_date, format = "%Y-%m-%d"), "%a %b %d")`** and aim to have a 1 hr **lunch break at `r params$lunch_time`** . We will then break for lunch and return for the **afternoon session at 2pm** which should last around another 2.5 hrs. 
